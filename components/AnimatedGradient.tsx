...
export default function AnimatedGradient() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      ...
      <div
        ref={gradient1Ref}
        className="absolute -top-1/4 -left-1/4 h-[600px] w-[600px] rounded-full bg-lime-green/15 blur-[120px]"
      />

      {/* Gradient 2 - Neon Yellow */}
      <div
        ref={gradient2Ref}
        className="absolute top-1/3 -right-1/4 h-[500px] w-[500px] rounded-full bg-neon-yellow/12 blur-[100px]"
      />

      {/* Gradient 3 - Lime Green */}
      <div
        ref={gradient3Ref}
        className="absolute -bottom-1/4 left-1/3 h-[400px] w-[400px] rounded-full bg-lime-green/10 blur-[80px]"
      />
    </div>
  );
}
